...
int main(int argc, char **argv)
{
	...
	// TOO BIG p^r also cosume level L TOO MUCH!
	// Such as : p = 100001651, r = 2, LEVEL = 8, L =17 
    ...
    cout<<"ciphertext result:= " << res[0]<<" = "<<conv<long>(res[0])<<endl;
    
	// Computer the plaintext product
    long ans = 1;
